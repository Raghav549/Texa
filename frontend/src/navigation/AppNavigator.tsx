...
export default function AppNavigator() {
  return (
    <NavigationContainer>
      <Tab.Navigator screenOptions={{ headerShown: true, tabBarActiveTintColor: theme.colors.neon, tabBarInactiveTintColor: theme.colors.gray, tabBarStyle: { backgroundColor: theme.colors.white, borderTopWidth: 0 } }}>
        <Tab.Screen name="Home" component={Home} options={{ tabBarIcon: ({ focused }) => <Text style={[styles.tab, { color: focused ? theme.colors.neon : theme.colors.gray }]}>🏠</Text> }} />
